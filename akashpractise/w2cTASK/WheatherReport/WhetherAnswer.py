...
# print(unq_file)
'''solution'''
# unq_data = data["Wind Speed_km/h"].nunique()
unq_data = data["Wind Speed_km/h"].unique()
print(unq_data)
...
'''solution'''
# condition = data.groupby('Weather').get_group('Clear')
# print(condition)
print("\n")
...
print("\n ffffffffffffffffffffffffffffffffffffffff", men_value)
